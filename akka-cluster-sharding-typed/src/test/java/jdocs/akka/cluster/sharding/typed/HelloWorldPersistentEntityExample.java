...
public class HelloWorldPersistentEntityExample {
  ...
  public static class HelloWorld
    ...
    public static Behavior<Command> create(String entityId) {
      return Behaviors.setup(context -> new HelloWorld(context, entityId));
    }

    private HelloWorld(ActorContext<Command> context, String entityId) {
      super(ENTITY_TYPE_KEY.persistenceIdFrom(entityId));
    }
